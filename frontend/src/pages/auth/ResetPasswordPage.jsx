        ...
        <div className="bg-[#131313] border border-white/[0.07] border-t-2 border-t-yellow-400 rounded-2xl p-6">
          {!token ? (
            <div className="text-center py-2">
              ...
              <h2 className="font-display font-black text-white text-lg uppercase mb-1.5">Link inválido</h2>
              <p className="text-sm text-white/40 mb-4">Este link de redefinição está incompleto ou expirou.</p>
              <a href="/esqueci-senha" className="text-yellow-400 text-sm hover:underline">Solicitar novo link</a>
            </div>
          ) : (
            <>
              <h2 className="font-display font-black text-white text-xl uppercase mb-0.5">Nova senha</h2>
              <p className="text-xs text-white/35 mb-6">Crie uma nova senha de acesso</p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPass ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                      className="input-field pl-9 pr-10" placeholder="••••••••" minLength={6} required />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPass ? 'text' : 'password'} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                      className="input-field pl-9" placeholder="••••••••" minLength={6} required />
                  </div>
                </div>
